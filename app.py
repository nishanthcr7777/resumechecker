    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/nishanthcr7777' target='_blank' style='text-decoration: none;'>
                    <div style='display: flex; align-items: center; background-color: #24292e; padding: 5px 10px; border-radius: 5px; transition: all 0.3s ease;'>
                        ...
                        <span style='color: white; font-size: 14px;'>visit my git</span>
                    </div>
                </a>
            </div>
            """, unsafe_allow_html=True)
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/nishanth-b-cr7/" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b></b>
                </a>
            </p>
     ...
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://avatars.githubusercontent.com/nishanthcr7777'}"
                     alt="Nishanth"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/nishanthcr7777';">
                <h2 class="profile-name">Nishanth</h2>
                <p class="profile-title">Full Stack Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/nishanthcr7777" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/nishanth-b-cr7/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:bnishanthtpm06@gmail.com" class="social-link" target="_blank">
